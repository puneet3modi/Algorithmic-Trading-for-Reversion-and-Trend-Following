...
def main() -> None:
    logger = setup_logger("sweep_costs_macd")
    ...
    bars_per_year = 365 * 24 * 4  # 15m crypto

    # Sweep costs from 0 to 10 bps per turnover unit
    ...
    out_path = f"{processed_dir}/{symbol}_{interval}_cost_sweep_macd.csv"
